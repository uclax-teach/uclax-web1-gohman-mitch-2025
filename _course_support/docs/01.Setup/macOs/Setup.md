...
3. paste the following, and press enter
    ...
    ```bash
    bash -i -c "$(curl -sSL https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/macOs-v2/1.macOs-mac-apps-part1.sh)"
    ```
...
9. Run the following command
    ...
    ```bash
    bash -i -c "$(curl -sSL https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/macOs-v2/2.macOs-mac-apps-part2.sh)"
    ```
...
5. paste the following in the terminal, and press enter
    ...
    ```bash
    bash -i -c "$(curl -sSL https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/macOs-v2/3.macOs-zsh-course-folder.sh)"
    ```
