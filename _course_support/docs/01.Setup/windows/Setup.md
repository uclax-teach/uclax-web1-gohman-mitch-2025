...
2. type the following command and press enter
    ...
    ```powershell
    Set-ExecutionPolicy Bypass -Scope Process -Force; Invoke-WebRequest -Uri "https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/win11-v5/1.install-windows-apps.ps1" -UseBasicParsing | Invoke-Expression
    ```
...
6. Run the following command
    ...
    ```bash
    bash -i -c "$(curl -sSL https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/win11-v5/2.wsl-ubuntu-root.sh)"
    ```
...
2. Paste the following in the terminal, and press enter
    ...
    ```bash
    bash -i -c "$(curl -sSL https://raw.githubusercontent.com/uclax-teach/uclax-web1-gohman-mitch-2025/refs/heads/master/_course_support/scripts/win11-v5/3.wsl-ubuntu-system-requirements-check.sh)"
    ```
